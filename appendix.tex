...
\pagebreak
\begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|}
\caption{Object Detection Results on the ART-Net Dataset.}
\label{fig:modelresults}
\hline
\multicolumn{11}{|c|}{\textbf{ART-Net Dataset}} \\
\hline
\multicolumn{1}{|c|}{} & \multicolumn{3}{c|}{\textbf{mAP_{0.5}}} & \multicolumn{3}{c|}{\textbf{mAP_{0.5:0.95}}} & \multicolumn{3}{c|}{\textbf{Training}} \\
\hline
\textbf{Model Name} & \textbf{Tool} & \textbf{Tooltip} & \textbf{Both} & \textbf{Tool} & \textbf{Tooltip} & \textbf{Both} & \textbf{Epochs} & \textbf{Training Time} & \textbf{Time per Epoch} \\ 
\hline
...
SIMO-VGG & 19.05 & 12.06 & 15.6 & 18.8 & 11.7 & 15.2 & 32 & 7.0 & 0.22 \\ 
DETR & 23.74 & 13.3 & 18.52 & 13.1 & 13.3 & 13.2 & \textbf{305} & 19.7 & 0.06 \\ 
\hline
\end{longtable}
\end{scriptsize}
