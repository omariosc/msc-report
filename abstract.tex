\begin{abstract}
    ...
    \textbf{Results:} Overall, the anchor-free YOLOv8-X model was the most accurate and efficient, achieving mAP$_{50}$ of 99.5\% and mAP$_{50:95}$ of 85.6\% with an inference time of 21.7ms/$\sim$46 FPS and 100\% tracking accuracy over detected objects.
