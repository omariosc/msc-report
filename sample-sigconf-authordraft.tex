...
\keywords{Surgical Tool Detection, Surgical Tool Tracking, Medical Image Analysis, Computer Vision, Machine Learning, Deep Learning, Convolutional Neural Networks (CNNs), Computer-assisted Laparoscopy, Surgical Training, Surgical Skill Improvement, Low and Middle-Income Countries (LMICs)}
%%
...
\begin{teaserfigure}
  ...
  \Description{Sample frame from our dataset showing the tracked fenestrated and curved forceps and their respective tips \textit{(left)}. A plot showing the performances of different models using mean average precicision against weighted inference time on multiple datasets \textit{(right)}.}
  \label{fig:teaser}
\end{teaserfigure}
...
We would like to thank the supervisors \href{mailto: D.P.Jones@leeds.ac.uk}{Dr Dominic Jones} and \href{mailto: S.S.Ali@leeds.ac.uk}{Dr Sharib Ali} for their guidance and support throughout the project.
\end{acks}
...
This study was approved by the University of Leeds School of Computing Ethics Committee. (Approval number: \textcolor{red}{\textit{[insert number here]}}).
...
The in-house dataset is not yet publically available, however will be in the future at the repository: \url{https://github.com/omariosc/msc-surgical-tool-tracking/}. The Augmented Reality Tool Network (ART-Net) dataset can be requested from the authors of the original paper in the following repository: \url{https://github.com/kamruleee51/ART-Net}. \cite{hasan_detection_2021}. The MICCAI 2015 EndoVis dataset \cite{bernal_comparative_2017} can be downloaded here: \url{https://web.archive.org/web/20230323215521/https://opencas.webarchiv.kit.edu/?q=node/30}. the PEg TRAnfer Workflow Dataset can be downloaded here: \url{https://www.synapse.org/Synapse:syn25147789/wiki/608879}.

\section*{Code Sharing Statement}

The code, including all helper files, scripts, notebooks, models and checkpoints used and results obtained in this study are all freely available at the repository: \url{https://github.com/omariosc/msc-surgical-tool-tracking/}.
