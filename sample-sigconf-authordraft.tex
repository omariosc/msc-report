...
% \newgeometry{left=1.75cm,bottom=2cm,top=2.5cm,right=1.75cm}
...
\authornote{School of Computer Science, Faculty of Engineering and Physical Sciences, University of Leeds, West Yorkshire, LS2 9JT, United Kingdom. Email: \href{mailto:O.Choudhry@leeds.ac.uk}{O.Choudhry@leeds.ac.uk}}
...
% \keywords{Surgical Tool Detection, Surgical Tool Tracking, Computer Vision, Machine Learning, Deep Learning, Surgical Training, Surgical Skill Improvement, Low and Middle-Income Countries (LMICs)}
%%
...
%   \Description{Sample frame from our dataset showing the tracked fenestrated and curved forceps and their respective tips \textit{(left)}. A plot showing the performances of different models using mean average precision against weighted inference time on multiple datasets \textit{(right)}.}
%   \label{fig:teaser}
% \end{teaserfigure}
...
The in-house Artificial Intelligence Enhanced Laparoscopic Training (AI-ELT) dataset is not yet publicly available; however, it will be in the future at the repository: \url{https://github.com/omariosc/AI-ELT/}. %The Augmented Reality Tool Network (ART-Net) dataset can be requested from the original paper's authors in the following repository: \url{https://github.com/kamruleee51/ART-Net}. \cite{hasan_detection_2021}. The MICCAI 2015 EndoVis dataset \cite{bernal_comparative_2017} can be downloaded here: \url{https://web.archive.org/web/20230323215521/https://opencas.webarchiv.kit.edu/?q=node/30}.Thee PEg TRAnfer Workflow Dataset can be downloaded here: \url{https://www.synapse.org/Synapse:syn25147789/wiki/608879}.
...
% This study was approved by the Ethics Committee of the University of Leeds School of Computing. (Approval number: \textcolor{red}{\textit{[insert number here]}}).
...
The in-house Artificial Intelligence Enhanced Laparoscopic Training (AI-ELT) dataset is not yet publicly available; however, it will be in the future at the repository: \url{https://github.com/omariosc/AI-ELT/}. %The Augmented Reality Tool Network (ART-Net) dataset can be requested from the original paper's authors in the following repository: \url{https://github.com/kamruleee51/ART-Net}. \cite{hasan_detection_2021}. The MICCAI 2015 EndoVis dataset \cite{bernal_comparative_2017} can be downloaded here: \url{https://web.archive.org/web/20230323215521/https://opencas.webarchiv.kit.edu/?q=node/30}. the PEg TRAnfer Workflow Dataset can be downloaded here: \url{https://www.synapse.org/Synapse:syn25147789/wiki/608879}.
...
% structures available in \LaTeX\@; this section will jive a couple
...
% \end{equation}
% jo demonstrate \LaTeX's able handling of numbering.
